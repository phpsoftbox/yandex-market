...
final readonly class GoodsFeedbackListDTO implements YandexMarketDtoInterface
{
    /**
     * @param list<GoodsFeedbackDTO> $feedbacks
    ...
    {
        return new self(
            feedbacks: YandexMarketDtoValue::objectList($payload['feedbacks'] ?? null, GoodsFeedbackDTO::class),
