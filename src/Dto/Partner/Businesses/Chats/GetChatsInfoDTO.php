...
final readonly class GetChatsInfoDTO implements YandexMarketDtoInterface
{
    /**
     * @param list<GetChatInfoDTO> $chats
    ...
    {
        return new self(
            chats: YandexMarketDtoValue::objectList($payload['chats'] ?? null, GetChatInfoDTO::class),
            paging: YandexMarketDtoValue::object($payload['paging'] ?? null, PackagingForwardScrollingPagerDTO::class),
            extra: YandexMarketDtoValue::extra($payload, ['chats', 'paging']),
        );
    }
}
