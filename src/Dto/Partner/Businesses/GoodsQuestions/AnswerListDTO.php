...
final readonly class AnswerListDTO implements YandexMarketDtoInterface
{
    /**
    ...
    {
        return new self(
            answers: YandexMarketDtoValue::objectList($payload['answers'] ?? null, AnswerDTO::class),
            paging: YandexMarketDtoValue::object($payload['paging'] ?? null, PackagingForwardScrollingPagerDTO::class),
            extra: YandexMarketDtoValue::extra($payload, ['answers', 'paging']),
        );
    }
}
