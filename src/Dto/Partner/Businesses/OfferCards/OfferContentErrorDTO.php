...
final readonly class OfferContentErrorDTO implements YandexMarketDtoInterface
{
    /**
    ...
    {
        return new self(
            type: YandexMarketDtoValue::object($payload['type'] ?? null, OfferContentErrorType::class),
