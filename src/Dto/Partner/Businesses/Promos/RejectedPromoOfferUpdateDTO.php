...
final readonly class RejectedPromoOfferUpdateDTO implements YandexMarketDtoInterface
{
    /**
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            reason: YandexMarketDtoValue::object($payload['reason'] ?? null, RejectedPromoOfferUpdateReasonType::class),
            extra: YandexMarketDtoValue::extra($payload, ['offerId', 'reason']),
        );
    }
}
