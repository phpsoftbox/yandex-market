...
use PhpSoftBox\YandexMarket\Dto\Partner\Businesses\Orders\BriefOrderItemInstanceDTO;
use PhpSoftBox\YandexMarket\Dto\YandexMarketDtoInterface;
use PhpSoftBox\YandexMarket\Dto\YandexMarketDtoValue;

final readonly class OrderBoxLayoutItemDTO implements YandexMarketDtoInterface
{
    /**
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            partialCount: YandexMarketDtoValue::object($payload['partialCount'] ?? null, OrderBoxLayoutPartialCountDTO::class),
