...
final readonly class GetCampaignOffersResultDTO implements YandexMarketDtoInterface
{
    /**
     * @param list<GetCampaignOfferDTO> $offers
    ...
    public static function fromArray(array $payload): static
    {
        return new self(
            ...
            offers: YandexMarketDtoValue::objectList($payload['offers'] ?? null, GetCampaignOfferDTO::class),
