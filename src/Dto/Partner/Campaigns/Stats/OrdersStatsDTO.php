...
final readonly class OrdersStatsDTO implements YandexMarketDtoInterface
{
    /**
     * @param list<OrdersStatsOrderDTO> $orders
    ...
    {
        return new self(
            orders: YandexMarketDtoValue::objectList($payload['orders'] ?? null, OrdersStatsOrderDTO::class),
            paging: YandexMarketDtoValue::object($payload['paging'] ?? null, PackagingForwardScrollingPagerDTO::class),
            extra: YandexMarketDtoValue::extra($payload, ['orders', 'paging']),
        );
    }
}
