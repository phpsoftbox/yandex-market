...
final readonly class GetSupplyRequestsDTO implements YandexMarketDtoInterface
{
    /**
     * @param list<SupplyRequestDTO> $requests
    ...
    {
        return new self(
            requests: YandexMarketDtoValue::objectList($payload['requests'] ?? null, SupplyRequestDTO::class),
            paging: YandexMarketDtoValue::object($payload['paging'] ?? null, PackagingForwardScrollingPagerDTO::class),
            extra: YandexMarketDtoValue::extra($payload, ['requests', 'paging']),
        );
    }
}
